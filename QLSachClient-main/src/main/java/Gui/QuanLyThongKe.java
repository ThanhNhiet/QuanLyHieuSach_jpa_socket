...
public class QuanLyThongKe extends javax.swing.JPanel {
     ...
     */
    public QuanLyThongKe(Socket socket) {
    	this.socket = socket;
        initComponents();
        Tab_HoaDon tab_HoaDon = new Tab_HoaDon(socket);
        jPanel2.removeAll();
        jPanel2.add(tab_HoaDon);
        jPanel2.revalidate();
        jPanel2.repaint();
    }
    ...
    private void jMenu15MenuSelected(javax.swing.event.MenuEvent evt) {//GEN-FIRST:event_jMenu15MenuSelected
        // TODO add your handling code here:
        Tab_SanPham tab_SanPham = new Tab_SanPham(socket);
        jPanel2.removeAll();
        jPanel2.add(tab_SanPham);
        jPanel2.revalidate();
        jPanel2.repaint();
